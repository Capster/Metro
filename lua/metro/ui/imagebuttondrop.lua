...
function PANEL:Init()
	...
	--[[self.m_Image.PaintOver = function(panel, w, h)
...
function PANEL:OnMousePressed( mousecode )
	...
	if mousecode == MOUSE_RIGHT then
		return self.functionRightCallback and self.functionRightCallback()
	end
...
Metro.Register( "MetroImageButtonDrop", PANEL, "DButton" )